...
class FormBuilderDropdownSingleSelect<T> extends FormBuilderFieldDecoration<T> {
  ...
  FormBuilderDropdownSingleSelect({
    super.key,
    required super.name,
    super.validator,
    super.initialValue,
    ...
    builder: (FormFieldState<T?> field) {
      final state = field as _FormBuilderDropdownSingleSelectState<T>;
  ...
  @override
  FormBuilderFieldDecorationState<FormBuilderDropdownSingleSelect<T>, T> createState() =>
      _FormBuilderDropdownSingleSelectState<T>();
}
class _FormBuilderDropdownSingleSelectState<T>
    extends FormBuilderFieldDecorationState<FormBuilderDropdownSingleSelect<T>, T> {
  @override
  void didUpdateWidget(covariant FormBuilderDropdownSingleSelect<T> oldWidget) {
