...
import 'package:think_form/resources/app_colors.dart';
import 'package:think_form/dropdown_single_form_builder.dart';


class FormBuilderDropdownMultiSelect<T> extends FormBuilderFieldDecoration<T> {
  ...
  FormBuilderDropdownMultiSelect({
    super.key,
    required super.name,
    super.validator,
    super.initialValue,
    ...
    builder: (FormFieldState<T?> field) {
      final state = field as _FormBuilderDropdownMultiSelectState<T>;
      ...
      return DropdownSearch<T>.multiSelection(
        ...
        onChanged: state.enabled ? (List<T>? value) => state.didChange(value?.join("-") as T?) : null,
        selectedItems: hasValue ? ((field.value is List<T>)?(field.value as List<T>) : const []) : const [],
        ...
        dropdownDecoratorProps: DropDownDecoratorProps(
          ...
          //           style: BorderStyle.none, color: AppColors.thinkRedColor)),
          // ),
        ),
        popupProps: PopupPropsMultiSelection.menu(
          showSearchBox: searchable ?? false,
          fit: FlexFit.loose,
          menuProps: MenuProps(
  ...
  @override
  FormBuilderFieldDecorationState<FormBuilderDropdownMultiSelect<T>, T> createState() =>
      _FormBuilderDropdownMultiSelectState<T>();
}
class _FormBuilderDropdownMultiSelectState<T>
    extends FormBuilderFieldDecorationState<FormBuilderDropdownMultiSelect<T>, T> {
  @override
  void didUpdateWidget(covariant FormBuilderDropdownMultiSelect<T> oldWidget) {
